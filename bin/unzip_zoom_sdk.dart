...
Future<void> checkAndDownloadSDK(String location) async {
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/s/9kdz71px6k1li42/MobileRTC?dl=1'),
        iosSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/s/04dgi1qwdl46xlq/MobileRTC?dl=1'),
        iosSimulateSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/s/u1ucro4smkwftc5/commonlib.aar?dl=1'),
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/s/s91gzc8356ghd4j/mobilertc.aar?dl=1'),
        androidRTCLibFile);
  }
}
