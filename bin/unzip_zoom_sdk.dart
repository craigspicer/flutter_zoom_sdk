...
Future<void> checkAndDownloadSDK(String location) async {
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/s/haxhdto5v5wkfo9/MobileRTC?dl=1'),
        iosSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse('https://www.dropbox.com/s/pu6h754d2y9qtaj/MobileRTC?dl=1'),
        iosSimulateSDKFile);
  }
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/s/e0yfd46qg0mt2tt/commonlib.aar?dl=1'),
  ...
  if (!exists) {
    await downloadFile(
        Uri.parse(
            'https://www.dropbox.com/s/76wwj9eze3f30q5/mobilertc.aar?dl=1'),
        androidRTCLibFile);
  }
}
